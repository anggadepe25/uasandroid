package com.anggadp.dong.uas;

public class Konfigurasi {
    public static final String URL_ADD="http://192.168.43.5/uasandroid/tambah.php";
    public static final String URL_GET_ALL="http://192.168.43.5/uasandroid/tampil.php";
